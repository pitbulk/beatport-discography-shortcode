...
Also you can specify a release or a track if you use the ID option
...
* Label
* ID
2. Which artist or label or id do you want:
* Artist Name (Default)
* Label Name
* id
...
= 1.2.0 =
* Bug fix. Check that at least one value is set in the admin shortcodepanel
* Option to fetch release or a track (based on ID)
* Pretty print a release and pretty print a track
